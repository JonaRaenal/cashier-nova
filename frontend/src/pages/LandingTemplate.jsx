        ...
        <div className="row py-3 border-bottom">
          ...
          <div className="col-sm-8 col-lg-2 d-flex gap-5 align-items-center justify-content-center justify-content-sm-end">
            <ul className="d-flex justify-content-end list-unstyled m-0">
              <li>
                <a href="/login" className="p-2 mx-1" title="Login to Admin Panel">
        ...
        <div className="row">
          <div className="col-lg-6 pt-5 mt-5">
            ...
            <div className="d-flex gap-3">
              ...
              <a href="/login" className="btn btn-dark text-uppercase fs-6 rounded-pill px-4 py-3 mt-3">Admin Login</a>
            </div>
                  ...
                  <div className="d-flex flex-column text-center">
                    ...
                    <div className="button-area p-3 pt-0">
                      <div className="row g-1 mt-2">
                        ...
                        <div className="col-7"><a href="#" className="btn btn-primary rounded-1 p-2 fs-7 btn-cart"><svg width="18" height="18"><use href="#cart"></use></svg> Add to Cart</a></div>
                        <div className="col-2"><a href="#" className="btn btn-outline-dark rounded-1 p-2 fs-6"><svg width="18" height="18"><use href="#heart"></use></svg></a></div>
                      </div>
                    </div>
                  </div>
                </div>
